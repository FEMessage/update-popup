...
git remote add github https://$GITHUB_TOKEN@github.com/FEMessage/update-popup.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/FEMessage/update-popup/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "update-popup更新", "text": "@所有人\n# [update-popup('$version')]('$html_url')\n'$body'"}}'
